    ...
    <div className="flex flex-wrap gap-2 mb-3 items-center">
      <div className="relative flex-grow min-w-[200px]">
        <input
          ...
          className="w-full pl-8 pr-20 py-2 text-xs border border-border rounded-md text-[13px] bg-white text-foreground shadow-sm focus:ring-2 focus:ring-blue-300 focus:border-blue-500 transition-all duration-200 hover:border-gray-400"
        />
