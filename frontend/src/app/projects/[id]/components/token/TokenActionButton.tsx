  ...
  return (
    <div className="flex flex-wrap gap-2 mb-4 items-center">
      <button
        ...
        className={`px-3 py-2 border border-transparent rounded-md text-[13px] shadow-sm transition-all duration-200 ${
      ...
      <button
        ...
        className={`px-3 py-2 rounded-md text-[13px] shadow-sm transition-all duration-200 ${
