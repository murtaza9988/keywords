  ...
  return (
    <div className="note-section border border-border rounded-lg overflow-hidden bg-surface shadow-sm">
      <div className="header flex items-center gap-2 p-2 bg-surface-muted border-b border-border">
        <label htmlFor={id} className="text-ui-body font-medium mr-2 text-foreground">
          {label}
        </label>
        <div className="toolbar flex gap-2 items-center">
          <button
            onClick={() => formatText("bold")}
            className="px-2.5 py-1 text-ui-size-meta bg-surface border border-border rounded hover:bg-surface-strong text-foreground transition-colors font-bold"
            title="Bold"
          >
            B
          </button>
          <select
            ...
            className="text-ui-size-meta bg-surface border border-border rounded px-2 py-1 text-foreground focus:outline-none focus:ring-1 focus:ring-accent"
            title="Font Size"
          >
      ...
      <div
        ...
        onInput={onChange}
        onWheel={onWheel}
        className="w-full text-ui-body text-foreground p-3 resize-y"
        style={{
          whiteSpace: "pre-wrap",
          minHeight: "150px",
          height: "150px",
